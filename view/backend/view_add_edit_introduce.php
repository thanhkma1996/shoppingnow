<div class="col-md-8 col-md-offset-2">
	<div class="panel panel-primary">
		<div class="panel-heading">Add edit introduce</div>
		<div class="panel-body">
			<form class="form-horizontal" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-md-10">
					<input type="checkbox" <?php echo isset($arr->c_hotintroduce)&&$arr->c_hotintroduce==1?"checked":""; ?> name="c_hotintroduce"> Hot introduce
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-md-2"></label>
					<div class="col-md-10">
					<?php if(isset($arr->c_img)&&file_exists("public/upload/introduce/".$arr->c_img&&$arr->c_img!="")){ ?>
					<img src="public/upload/introduce/<?php echo $arr->c_img; ?>" style="max-width: 100px;">
					<?php } ?>
					</div>
				</div>
				<div class="form-group">
